...
- [x] T001 Verify Node.js ≥18.x and npm ≥9.x installed (pre-requisite check)
...
- [x] T019 [P] Configure WCAG AA compliant theme colors in book/src/css/custom.css (verify contrast ratios ≥4.5:1)
